...
@section('title','Item Type - Update')
...
<div class="card elevation-2">
    <div>
        <div class="card-header">
            <input type="hidden" id="ida" value="{{ $datatype->IDArticleType }}">
            <input type="hidden" id="kode" value="{{ $datatype->KodeAwal }}">
            <h2 class="card-title" style="display: flex; align-items: center;">
                <b>{{ $datatype->KodeAwal }} - {{ $datatype->NamaJenisArticle }}</b></h2>
        </div>
        <div class="card-body">
            <div class="row">
            ...
            <div class="row form-horizontal">
                <div class="col-sm-6">
                    ...
                    <label class="col-sm-4 col-form-label" for="nama">Item Type Name <a style="color:red;">*</a></label>
                        <div class="col-sm-7">
                        <input type="text" class="form-control" id="nama" placeholder="Item Type" value="{{ $datatype->NamaJenisArticle }}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row form-horizontal">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                        <input type="text" id="note" class="form-control" value="{{ $datatype->Note }}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
        ...
        <div class="modal fade" id="update-scd">
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-footer">
                    <a href="/article/type" class="btn btn-default"><b>Close</b></a>
                </div>
                </div>
            </div>
        </div>
        ...
        $.ajax({
            ...
            success:function(data){
                if(JSON.stringify(data).split('"').join('') == 'error'){
                    ...
                    window.location.href = "/article/type";
                }
           }
        });
    }
