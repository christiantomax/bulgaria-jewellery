...
<meta charset="utf-8">
    ...
    <title>BULGARIA | Invoice Custom Order</title>
...
<div class="row" style="height: 30vh; width: 152vw; padding: 1.5% 1.5% 0% 2%;">
    <div class="col-12" style="background-image: url({{ asset('template/dist/img/invoice/inv_header.jpg') }});
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="row">
                    <div class="col-6"><h6 style="margin-left: 10%; margin-top: 3%;">CO Date : <b>{{ $data[0]->created_at }}</b></h6></div>
        ...
        <div class="row">
            <div class="col-7"></div>
            <div class="col-5">
                <h5 class="float-right">No CO. : <b>{{ $data[0]->IDCO }}</b></h5>
            </div>
        </div>
        ...
        <br><div class="row">
            <div class="col-7"></div>
            <div class="col-5">
                <h7 class="float-right">To : <b>{{ $data[0]->Nama }}</b></h7>
            </div>
        </div>
        <div class="row">
            <div class="col-7"></div>
            <div class="col-5">
                <h7 class="float-right"><b>{{ $data[0]->Telepon }}</b></h7>
            </div>
        </div>
        <div class="row">
            <div class="col-7"></div>
            <div class="col-5" style="text-align: right;">
                <h7 class="float-right"><b>{{ $data[0]->Alamat }}</b></h7>
            </div>
        </div>
    </div>
</div>
...
@foreach($data as $row)
    <div class="row" style="height: {{ 100/count($data) }}%; display: flex; align-items: center;">
        <div class="col-6" style="height: 100%; width: 100%; padding: 1% 5% 1% 5%;">
            <div class="col-12" style="height: 100%; width: 100%; 
            background-image: url({{ $row->Path}});
            background-size: cover;">
            </div>
        </div>
        <div class="col-6">
            <h3><b>{{ $row->NamaJenisType }}</b></h3><br> 
                    {{ $row->Size }}, {{ $row->Weight }}, {{ $row->MetalType }}, 
                    {{ $row->Quality }}, {{ $row->LaborCost }}, {{ $row->GoldPrice }}
                    <br>
                    Nilai Pengerjaan : {{ $row->HargaFinal }}
                    <br>
                    Note: {{ $row->Note }}
        </div>
    </div>
    ...
    <div class="col-12" style="background-image: url({{ asset('template/dist/img/invoice/amount.jpg') }});
        ...
        <div class="row">
            ...
            <div class="col-6" style="text-align: center; color: white;">
                <h4 class="float-left" id="amount">{{ $data[0]->totalharga }}</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-3"></div>
